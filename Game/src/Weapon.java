public enum Weapon {
    KUNAI(6,"./Game/Sprites/Weapons/Kunai/Sprite.png","./Game/Sprites/Weapons/Kunai/SpriteInHand.png",5,6,true,1,100,5),
    SAI(10,"./Game/Sprites/Weapons/Sai/Sprite.png","./Game/Sprites/Weapons/Sai/SpriteInHand.png",10,6,false,1,0,0),
    SHURIKEN(3,"./Game/Sprites/Weapons/Shuriken/Sprite.png","./Game/Sprites/Weapons/Shuriken/SpriteInHand.png",5,6,true,2,50,2),
    ;
